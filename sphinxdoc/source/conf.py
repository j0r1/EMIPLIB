...
# -*- coding: utf-8 -*-
#
# EMIPLIB documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'emiplibdoc.tex', 'EMIPLIB Documentation',
     'Hasselt University / Expertise Centre for Digital Media', 'manual'),
]
...
man_pages = [
    (master_doc, 'emiplibdoc', 'EMIPLIB Documentation',
     [author], 1)
]
