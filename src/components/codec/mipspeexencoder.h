 ...
 *  Using this component, floating point mono raw audio messages can be compressed using
 *  the Speex codec. Messages generated by this component are encoded audio messages with
 *  subtype MIPENCODEDAUDIOMESSAGE_TYPE_SPEEX.
 */
